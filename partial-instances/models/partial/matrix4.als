abstract sig Value {}
one sig dense, sparse, list_ds, array_ds, list_alg, array_alg, other_ds,other_alg extends Value {}

abstract sig Variable {
//domain: set Value,
} 

one sig Matrix extends Variable {
}

one sig Ds extends Variable {
}

one sig Alg extends Variable {
}
