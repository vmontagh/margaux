...
pred approximate_1203708334[]{(  GrabbedInOrder[ ]) some holds}

pred NOT_approximate_1203708334[]{( SzGrwtStrc_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next] ) and this/lowerBoundProcess and this/GrabOrRelease some holds}

run approximate_1203708334  for 5 State, 5 Process, 4 Mutex
run NOT_approximate_1203708334  for 5 State, 5 Process, 4 Mutex
