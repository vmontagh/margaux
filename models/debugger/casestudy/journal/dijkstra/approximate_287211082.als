...
pred approximate_287211082[]{(  GrabOrRelease[ ]) some holds}

pred NOT_approximate_287211082[]{( SzGrwtStrc_Lcl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next] ) and this/lowerBoundProcess and this/GrabbedInOrder some holds}

run approximate_287211082  for 5 State, 5 Process, 4 Mutex
run NOT_approximate_287211082  for 5 State, 5 Process, 4 Mutex
