...
pred approximate_130735100[]{(  GrabbedInOrder[ ]) some holds}

pred NOT_approximate_130735100[]{( SzGrwt_Glbl_SdEnd_EmptStrt_[holds,State,Process,Mutex,so/first,so/next] ) and this/lowerBoundProcess and this/GrabOrRelease some holds}

run approximate_130735100  for 5 State, 5 Process, 4 Mutex
run NOT_approximate_130735100  for 5 State, 5 Process, 4 Mutex
