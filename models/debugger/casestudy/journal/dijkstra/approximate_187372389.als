...
pred approximate_187372389[]{(  GrabbedInOrder[ ]) some holds}

pred NOT_approximate_187372389[]{( OrdDcrs_SzGrwt_Lcl_SdEnd_EmptStrt_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next] ) and this/lowerBoundProcess and this/GrabOrRelease some holds}

run approximate_187372389  for 5 State, 5 Process, 4 Mutex
run NOT_approximate_187372389  for 5 State, 5 Process, 4 Mutex
