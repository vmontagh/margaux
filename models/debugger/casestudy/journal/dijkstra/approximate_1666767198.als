...
pred approximate_1666767198[]{(  GrabbedInOrder[ ]) some holds}

pred NOT_approximate_1666767198[]{( SzGrwt_Glbl_SdMdl_EmptStrt_[holds,State,Process,Mutex,so/first,so/next] ) and this/lowerBoundProcess and this/GrabOrRelease some holds}

run approximate_1666767198  for 5 State, 5 Process, 4 Mutex
run NOT_approximate_1666767198  for 5 State, 5 Process, 4 Mutex
