...
pred approximate_402784446[]{(  GrabOrRelease[ ]) some holds}

pred NOT_approximate_402784446[]{( SzNChng_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next] ) and this/lowerBoundProcess and this/GrabbedInOrder some holds}

run approximate_402784446  for 5 State, 5 Process, 4 Mutex
run NOT_approximate_402784446  for 5 State, 5 Process, 4 Mutex
