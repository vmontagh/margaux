...
pred approximate_462453602[]{(  GrabbedInOrder[ ]) some holds}

pred NOT_approximate_462453602[]{( OrdIncrs_SzGrwt_Lcl_SdEnd_EmptStrt_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next] ) and this/lowerBoundProcess and this/GrabOrRelease some holds}

run approximate_462453602  for 5 State, 5 Process, 4 Mutex
run NOT_approximate_462453602  for 5 State, 5 Process, 4 Mutex
