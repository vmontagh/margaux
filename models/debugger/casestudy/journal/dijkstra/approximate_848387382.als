...
open temporal_properties_tagged
...
pred approximate_848387382[]{(  GrabbedInOrder[ ]) some holds}

pred NOT_approximate_848387382[]{( OrdIncrs_SzGrwt_Glbl_SdEnd_EmptStrt_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next] ) and this/lowerBoundProcess and this/GrabOrRelease some holds}

run approximate_848387382  for 5 State, 5 Process, 4 Mutex
run NOT_approximate_848387382  for 5 State, 5 Process, 4 Mutex
