...
pred approximate_551531076[]{(  GrabbedInOrder[ ]) some holds}

pred NOT_approximate_551531076[]{( SzGrwtStrc_Lcl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next] ) and this/lowerBoundProcess and this/GrabOrRelease some holds}

run approximate_551531076  for 5 State, 5 Process, 4 Mutex
run NOT_approximate_551531076  for 5 State, 5 Process, 4 Mutex
