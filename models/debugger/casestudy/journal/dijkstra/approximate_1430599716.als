...
pred approximate_1430599716[]{(  GrabOrRelease[ ]) some holds}

pred NOT_approximate_1430599716[]{( SzNChng_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next] ) and this/lowerBoundProcess and this/GrabbedInOrder some holds}

run approximate_1430599716  for 5 State, 5 Process, 4 Mutex
run NOT_approximate_1430599716  for 5 State, 5 Process, 4 Mutex
