...
pred deltaName[name: set Name, name': set Name, name'': set Name] {
    name != name' implies (name'' = name' - name and name'' + name = name') else no name''
}

pred deltaDate[date: set Date, date': set Date, date'': set Date] {
    date != date' implies (date'' = date' - date and date'' + date = date') else no date''
}

pred deltaBirthdayBook[birthdayBook: set BirthdayBook, birthdayBook': set BirthdayBook, birthdayBook'': set BirthdayBook] {
...
pred deltaBirthdayBook_known[birthdayBook_known: BirthdayBook->Name, birthdayBook_known': BirthdayBook->Name, birthdayBook_known'': BirthdayBook->Name] {
...
pred deltaBirthdayBook_date[birthdayBook_date: BirthdayBook->Name->Date, birthdayBook_date': BirthdayBook->Name->Date, birthdayBook_date'': BirthdayBook->Name->Date] {
...
pred structuralConstraints [name: set Name, date: set Date, birthdayBook: set BirthdayBook, birthdayBook_known: BirthdayBook->Name, birthdayBook_date: BirthdayBook->Name->Date] {
    ...
    (all p_this: one birthdayBook | ((((p_this . birthdayBook_date) in ((p_this . birthdayBook_known) -> date)) && (all v0: one (p_this . birthdayBook_known) | (one (v0 . (p_this . birthdayBook_date)) && ((v0 . (p_this . birthdayBook_date)) in date)))) && (all v1: one date | (((p_this . birthdayBook_date) . v1) in (p_this . birthdayBook_known)))))
...
pred findMarginalInstances[] {
    some name, name', name'': set Name, date, date', date'': set Date, birthdayBook, birthdayBook', birthdayBook'': set BirthdayBook, birthdayBook_known, birthdayBook_known', birthdayBook_known'': set BirthdayBook->Name, birthdayBook_date, birthdayBook_date', birthdayBook_date'': set BirthdayBook->Name->Date | {
            (
            isInstance[name, date, birthdayBook, birthdayBook_known, birthdayBook_date]
        ...
        and
            all name1, name1', name1'': set Name, date1, date1', date1'': set Date, birthdayBook1, birthdayBook1', birthdayBook1'': set BirthdayBook, birthdayBook_known1, birthdayBook_known1', birthdayBook_known1'': set BirthdayBook->Name, birthdayBook_date1, birthdayBook_date1', birthdayBook_date1'': set BirthdayBook->Name->Date | {
                    (
                    isInstance[name1, date1, birthdayBook1, birthdayBook_known1, birthdayBook_date1]
                ...
                implies
                    (
                    sigma[#name'', #date'', #birthdayBook'', #birthdayBook_known'', #birthdayBook_date''] <= sigma[#name1'', #date1'', #birthdayBook1'', #birthdayBook_known1'', #birthdayBook_date1'']
                    )
            }
    }
}

fun sigma [a1, a2, a3, a4, a5: Int] : Int {
    a1.add[a2].add[a3].add[a4].add[a5]
}
