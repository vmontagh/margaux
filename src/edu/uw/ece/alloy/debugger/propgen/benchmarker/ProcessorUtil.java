...
public class ProcessorUtil {
	...
	protected final static Logger logger = Logger.getLogger(ProcessorUtil.class.getName()+"--"+Thread.currentThread().getName());;
	...
	public static InetSocketAddress  findEmptyLocalSocket() {
		try {
			return findEmptyLocalSocket(InetAddress.getByName(InetAddress.getLocalHost().getHostAddress()));
		} catch (UnknownHostException e) {
			logger.log(Level.SEVERE, "["+Thread.currentThread().getName()+"] " +"The Local IP address cannot be found ", e);
			e.printStackTrace();
	 ...
	 * @return
	 */
	public synchronized static InetSocketAddress  findEmptyLocalSocket(final InetAddress localAddress){
	...
	public static void main(String ... args) throws UnknownHostException{
		System.out.println(findEmptyLocalSocket().getHostString());
