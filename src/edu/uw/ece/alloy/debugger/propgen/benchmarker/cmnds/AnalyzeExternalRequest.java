...
public class AnalyzeExternalRequest extends RemoteCommand {
    ...
    public AnalyzeExternalRequest(Boolean doVAC, Boolean doIFF, Boolean doIMPLY, Boolean doAND, String relationalPropModuleOriginal, String temporalPropModuleOriginal, String toBeAnalyzedCode) {
        super();
        this.doVAC = doVAC;
        this.doIFF = doIFF;
