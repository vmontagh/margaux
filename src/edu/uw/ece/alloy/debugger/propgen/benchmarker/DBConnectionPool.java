...
public abstract class DBConnectionPool {
	...
	public Connection getPooledConnection() throws SQLException{
		if(!isprepared){
			if(Configuration.IsInDeubbungMode) logger.info("["+Thread.currentThread().getName()+"] " + "Preparing the connection pool to "+getConnectionURL());
			prepareConnection();
			isprepared = true;
		}
	...
	protected DBConnectionPool(final DBConnectionInfo dBConnectionInfo, final int poolSizeIncrement, final int maxPoolSize){
	...
	public abstract DBConnectionPool createIt(final DBConnectionInfo dBConnectionInfo, final int poolSizeIncrement, final int maxPoolSize);
	public abstract DBConnectionPool createIt(final DBConnectionInfo dBConnectionInfo);
