...
/**
 * The interface expresses the Visitor interface of the visitor pattern. Once an
 * event is fired, an implementation of this interface is passed to the message
 * object.
 * 
 * @author vajih
 *
