...
public class AnalyzerRunner {
	...
	public static DBConnectionInfo getDefaultConnectionInfo()
			throws SQLException {
		dbConnectionInfo = dbConnectionInfo != null ? dbConnectionInfo
				: DBLogger
						.createConfiguredSetuperObject(
								new MySQLDBConnectionPool(Compressor.EMPTY_DBCONNECTION))
						.makeNewConfiguredDatabaseLog();
