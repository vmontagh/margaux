...
public abstract class CompositeSizes extends Property {

	final SizeProperty size1, size2;

	public CompositeSizes(String rName, String sName, String sNext,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CompositeSizes)) {
			return false;
		}
		CompositeSizes other = (CompositeSizes) obj;
		if (size1 == null) {
			if (other.size1 != null) {
				return false;
			}
