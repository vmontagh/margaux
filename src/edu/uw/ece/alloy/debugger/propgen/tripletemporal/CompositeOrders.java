...
public abstract class CompositeOrders extends Property {

	final Order order1, order2;
	
	public CompositeOrders(String rName, String sName, String sNext,
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CompositeOrders)) {
			return false;
		}
		CompositeOrders other = (CompositeOrders) obj;
		if (order1 == null) {
