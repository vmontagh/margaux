...
public class SideNone extends Side  implements SideOrdered {


	public SideNone(String rName, String sName, String sNext, String sFirst,
	...
	public boolean isConsistentOrdered() {
		...
		if( !(EndFirst == null || EndFirst.equals("")) ) return false;
		if( !(EndNext == null || EndNext.equals("")) ) return false;
		if( !(MiddleFirst == null || MiddleFirst.equals("")) ) return false;
		if( !(MiddleNext == null || MiddleNext.equals("")) ) return false;
