...
public class OrdIncrsStrc extends Ord {
	...
	public OrdIncrsStrc(String rName, String sName, String sNext, String sFirst,
	...
	protected String genOrder() {
		return " relational_properties/lt[relational_properties/max["
				+ sizeProp.orderedChange() + "," + sideOrdered.getNext()
