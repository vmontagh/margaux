...
public class DebuggerRunnerTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		allMokedApproximations.get("dph").get("weakestCon").put("( ( lowerBoundProcess[ ] ) and ( GrabOrRelease[ ] ) and ( GrabbedInOrder_3[ ] ) )waits for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzGrwt_Glbl_SdEnd_EmptNon_", "SzGrwt_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwt_Glbl_SdMdl_EmptNon_", "SzGrwt_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]")));
		allMokedApproximations.get("dph").get("weakestCon").put("( ( lowerBoundProcess[ ] ) and ( GrabOrRelease[ ] ) and ( GrabbedInOrder_3[ ] ) )holds for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzGrwt_Glbl_SdEnd_EmptNon_", "SzGrwt_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwt_Glbl_SdMdl_EmptNon_", "SzGrwt_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]")));
		allMokedApproximations.get("dph").get("weakestCon").put("( ( lowerBoundProcess[ ] ) and ( GrabOrRelease[ ] ) and ( GrabbedInOrder_4[ ] ) )waits for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzGrwt_Glbl_SdEnd_EmptNon_", "SzGrwt_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwt_Glbl_SdMdl_EmptNon_", "SzGrwt_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]")));
		allMokedApproximations.get("dph").get("weakestCon").put("( ( lowerBoundProcess[ ] ) and ( GrabOrRelease[ ] ) and ( GrabbedInOrder_4[ ] ) )holds for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzGrwt_Glbl_SdEnd_EmptNon_", "SzGrwt_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwt_Glbl_SdMdl_EmptNon_", "SzGrwt_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]")));
		...
		allMokedApproximations.get("dph").get("strongestImpl").put(" lowerBoundProcess[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("strongestImpl").put(" GrabOrRelease[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("strongestImpl").put(" GrabbedInOrder_3[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("strongestImpl").put(" lowerBoundProcess[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("strongestImpl").put(" GrabOrRelease[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("strongestImpl").put(" GrabbedInOrder_3[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("strongestImpl").put(" lowerBoundProcess[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("strongestImpl").put(" GrabOrRelease[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("strongestImpl").put(" GrabbedInOrder_4[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("strongestImpl").put(" lowerBoundProcess[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("strongestImpl").put(" GrabOrRelease[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("strongestImpl").put(" GrabbedInOrder_4[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		...
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabbedInOrder_2[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("OrdDcrs_SzGrwtStrc_Glbl_SdEnd_EmptNon_", "OrdDcrs_SzGrwtStrc_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptNon_", "OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Lcl_SdMdl_EmptNon_", "OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptStrt_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Glbl_SdMdl_EmptNon_", "OrdDcrs_SzGrwtStrc_Glbl_SdEnd_EmptStrt_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put("( ( lowerBoundProcess[ ] ) and ( GrabOrRelease[ ] ) and ( GrabbedInOrder_3[ ] ) )waits for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzNChng_Glbl_SdMdl_EmptNon_", "SzNChng_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdMdl_EmptNon_", "SzGrwtStrc_Lcl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdMdl_EmptNon_", "SzShrnk_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Glbl_SdEnd_EmptNon_", "SzGrwtStrc_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzNChng_Glbl_SdEnd_EmptNon_", "SzNChng_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdEnd_EmptNon_", "SzGrwtStrc_Lcl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Glbl_SdMdl_EmptNon_", "SzGrwtStrc_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdEnd_EmptNon_", "SzShrnk_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put(" lowerBoundProcess[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("weakestIncon").put(" lowerBoundProcess[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabOrRelease[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzNChng_Glbl_SdMdl_EmptNon_", "SzNChng_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdMdl_EmptNon_", "SzGrwtStrc_Lcl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdMdl_EmptNon_", "SzShrnk_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Glbl_SdEnd_EmptNon_", "SzGrwtStrc_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzNChng_Glbl_SdEnd_EmptNon_", "SzNChng_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdEnd_EmptNon_", "SzGrwtStrc_Lcl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Glbl_SdMdl_EmptNon_", "SzGrwtStrc_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdEnd_EmptNon_", "SzShrnk_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabOrRelease[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzNChng_Glbl_SdMdl_EmptNon_", "SzNChng_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdMdl_EmptNon_", "SzGrwtStrc_Lcl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdMdl_EmptNon_", "SzShrnk_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Glbl_SdEnd_EmptNon_", "SzGrwtStrc_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzNChng_Glbl_SdEnd_EmptNon_", "SzNChng_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdEnd_EmptNon_", "SzGrwtStrc_Lcl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Glbl_SdMdl_EmptNon_", "SzGrwtStrc_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdEnd_EmptNon_", "SzShrnk_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabbedInOrder_3[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabbedInOrder_3[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("weakestIncon").put("( ( lowerBoundProcess[ ] ) and ( GrabOrRelease[ ] ) and ( GrabbedInOrder_3[ ] ) )holds for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzNChng_Glbl_SdEnd_EmptNon_", "SzNChng_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptNon_", "OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]"), new Pair<>("SzNChng_Glbl_SdMdl_EmptNon_", "SzNChng_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdMdl_EmptNon_", "SzGrwtStrc_Lcl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Glbl_SdMdl_EmptNon_", "OrdDcrs_SzGrwtStrc_Glbl_SdEnd_EmptStrt_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]"), new Pair<>("SzShrnk_Glbl_SdMdl_EmptNon_", "SzShrnk_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdEnd_EmptNon_", "SzShrnk_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Glbl_SdEnd_EmptNon_", "OrdDcrs_SzGrwtStrc_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put(" lowerBoundProcess[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("weakestIncon").put(" lowerBoundProcess[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabOrRelease[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzNChng_Glbl_SdEnd_EmptNon_", "SzNChng_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzNChng_Glbl_SdMdl_EmptNon_", "SzNChng_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdMdl_EmptNon_", "SzGrwtStrc_Lcl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdMdl_EmptNon_", "SzShrnk_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdEnd_EmptNon_", "SzShrnk_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabOrRelease[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzNChng_Glbl_SdEnd_EmptNon_", "SzNChng_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzNChng_Glbl_SdMdl_EmptNon_", "SzNChng_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdMdl_EmptNon_", "SzGrwtStrc_Lcl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdMdl_EmptNon_", "SzShrnk_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdEnd_EmptNon_", "SzShrnk_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabbedInOrder_3[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("OrdDcrs_SzGrwtStrc_Glbl_SdEnd_EmptNon_", "OrdDcrs_SzGrwtStrc_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptNon_", "OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Lcl_SdMdl_EmptNon_", "OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptStrt_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Glbl_SdMdl_EmptNon_", "OrdDcrs_SzGrwtStrc_Glbl_SdEnd_EmptStrt_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabbedInOrder_3[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("OrdDcrs_SzGrwtStrc_Glbl_SdEnd_EmptNon_", "OrdDcrs_SzGrwtStrc_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptNon_", "OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Lcl_SdMdl_EmptNon_", "OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptStrt_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Glbl_SdMdl_EmptNon_", "OrdDcrs_SzGrwtStrc_Glbl_SdEnd_EmptStrt_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put("( ( lowerBoundProcess[ ] ) and ( GrabOrRelease[ ] ) and ( GrabbedInOrder_4[ ] ) )waits for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzNChng_Glbl_SdMdl_EmptNon_", "SzNChng_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdMdl_EmptNon_", "SzGrwtStrc_Lcl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdMdl_EmptNon_", "SzShrnk_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Glbl_SdEnd_EmptNon_", "SzGrwtStrc_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzNChng_Glbl_SdEnd_EmptNon_", "SzNChng_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdEnd_EmptNon_", "SzGrwtStrc_Lcl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Glbl_SdMdl_EmptNon_", "SzGrwtStrc_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdEnd_EmptNon_", "SzShrnk_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put(" lowerBoundProcess[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("weakestIncon").put(" lowerBoundProcess[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabOrRelease[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzNChng_Glbl_SdMdl_EmptNon_", "SzNChng_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdMdl_EmptNon_", "SzGrwtStrc_Lcl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdMdl_EmptNon_", "SzShrnk_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Glbl_SdEnd_EmptNon_", "SzGrwtStrc_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzNChng_Glbl_SdEnd_EmptNon_", "SzNChng_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdEnd_EmptNon_", "SzGrwtStrc_Lcl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Glbl_SdMdl_EmptNon_", "SzGrwtStrc_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdEnd_EmptNon_", "SzShrnk_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabOrRelease[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzNChng_Glbl_SdMdl_EmptNon_", "SzNChng_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdMdl_EmptNon_", "SzGrwtStrc_Lcl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdMdl_EmptNon_", "SzShrnk_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Glbl_SdEnd_EmptNon_", "SzGrwtStrc_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzNChng_Glbl_SdEnd_EmptNon_", "SzNChng_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdEnd_EmptNon_", "SzGrwtStrc_Lcl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Glbl_SdMdl_EmptNon_", "SzGrwtStrc_Glbl_SdMdl_EmptNon_[waits,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdEnd_EmptNon_", "SzShrnk_Glbl_SdEnd_EmptNon_[waits,State,Process,Mutex,so/first,so/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabbedInOrder_4[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabbedInOrder_4[ ]waits for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("weakestIncon").put("( ( lowerBoundProcess[ ] ) and ( GrabOrRelease[ ] ) and ( GrabbedInOrder_4[ ] ) )holds for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzNChng_Glbl_SdEnd_EmptNon_", "SzNChng_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptNon_", "OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]"), new Pair<>("SzNChng_Glbl_SdMdl_EmptNon_", "SzNChng_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdMdl_EmptNon_", "SzGrwtStrc_Lcl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdMdl_EmptNon_", "SzShrnk_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdEnd_EmptNon_", "SzShrnk_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put(" lowerBoundProcess[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("weakestIncon").put(" lowerBoundProcess[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList());
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabOrRelease[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzNChng_Glbl_SdEnd_EmptNon_", "SzNChng_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzNChng_Glbl_SdMdl_EmptNon_", "SzNChng_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdMdl_EmptNon_", "SzGrwtStrc_Lcl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdMdl_EmptNon_", "SzShrnk_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdEnd_EmptNon_", "SzShrnk_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabOrRelease[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("SzNChng_Glbl_SdEnd_EmptNon_", "SzNChng_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzNChng_Glbl_SdMdl_EmptNon_", "SzNChng_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzGrwtStrc_Lcl_SdMdl_EmptNon_", "SzGrwtStrc_Lcl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdMdl_EmptNon_", "SzShrnk_Glbl_SdMdl_EmptNon_[holds,State,Process,Mutex,so/first,so/next]"), new Pair<>("SzShrnk_Glbl_SdEnd_EmptNon_", "SzShrnk_Glbl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabbedInOrder_4[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptNon_", "OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Lcl_SdMdl_EmptNon_", "OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptStrt_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]")));
		allMokedApproximations.get("dph").get("weakestIncon").put(" GrabbedInOrder_4[ ]holds for 5 State, 5 Process, 4 Mutex", Arrays.asList(new Pair<>("OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptNon_", "OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptNon_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]"), new Pair<>("OrdDcrs_SzGrwtStrc_Lcl_SdMdl_EmptNon_", "OrdDcrs_SzGrwtStrc_Lcl_SdEnd_EmptStrt_[holds,State,Process,Mutex,so/first,so/next,mo/first,mo/next]")));
		...
		allMokedApproximations.get("dph").get("isIncon").put("( ( lowerBoundProcess[ ] ) and ( GrabOrRelease[ ] ) and ( GrabbedInOrder_3[ ] ) )holds for 5 State, 5 Process, 4 Mutex", false);
		allMokedApproximations.get("dph").get("isIncon").put("( ( lowerBoundProcess[ ] ) and ( GrabOrRelease[ ] ) and ( GrabbedInOrder_3[ ] ) )waits for 5 State, 5 Process, 4 Mutex", false);
		allMokedApproximations.get("dph").get("isIncon").put("( ( lowerBoundProcess[ ] ) and ( GrabOrRelease[ ] ) and ( GrabbedInOrder_4[ ] ) )holds for 5 State, 5 Process, 4 Mutex", false);
		allMokedApproximations.get("dph").get("isIncon").put("( ( lowerBoundProcess[ ] ) and ( GrabOrRelease[ ] ) and ( GrabbedInOrder_4[ ] ) )waits for 5 State, 5 Process, 4 Mutex", false);
	...
	public void testHeuristicDPH3() {
		testHeuristic("dijkstra.bug3.als", "corrected.dijkstra.bug3.als");
	}
	...
	public void testHeuristicDPH4() {
		testHeuristic("dijkstra.bug4.als", "corrected.dijkstra.bug4.als");
	}

	@Test
	public void testHeuristicMockedDPH4() {
		testHeuristicMocked("dijkstra.bug4.als", "corrected.dijkstra.bug4.als", "dph");
	}

	@Test
	public void testRandomDPH4() {
		testRandom("dijkstra.bug4.als", "corrected.dijkstra.bug4.als");

	}

	@Test
	public void testRandomMockedDPH4() {
		testRandomMocked("dijkstra.bug4.als", "corrected.dijkstra.bug4.als", "dph");
	}
