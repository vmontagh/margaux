...
public class PropertyCheckingBuilder {
	...
	final List<PropertyCheckingSource> checkers = Collections
	...
	public PropertyCheckingBuilder(File sourceFile, String property,
			String fieldName, Set<String> binaryProperties,
			Set<String> ternaryProperties, String emptyProperty, String functions,
			String sigs, String openModule, String openStatements,
			String commandHeader, String formula, String commandScope,
			String facts_) {
		super();
	...
	public void addChecker(Class<? extends PropertyCheckingSource> clazz) {
		...
		try {
			constructor = clazz.getConstructor(File.class, String.class, String.class,
					Set.class, Set.class, String.class, String.class, String.class,
					String.class, String.class, String.class, String.class, String.class);

			checkers.add(constructor.newInstance(this.sourceFile, this.property,
					this.fieldName, this.binaryProperties, this.ternaryProperties,
					this.sigs, this.openModule, this.openStatements, this.functions,
					this.commandHeader, this.formula, this.commandScope, this.facts));
			assert (checkers.get(checkers.size() - 1).repOk()) : String.format(
					"Object is failed: %n%s",
					checkers.get(checkers.size() - 1).toString());
		} catch (NoSuchMethodException | SecurityException | InstantiationException
				| IllegalAccessException | IllegalArgumentException
				| InvocationTargetException e) {
			e.printStackTrace();
			throw new RuntimeException(
					String.format("An object of %s cannot be created due to: %s",
							clazz.getName(), e.getMessage()));
		}
	}

	public void registerPropertyChecking(
			Class<? extends PropertyCheckingSource> clazz) {
