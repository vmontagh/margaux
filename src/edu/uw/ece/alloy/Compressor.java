...
public class Compressor {
	...
	final public static UUID EMPTY_UUID = UUID
			.fromString("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa");
	final public static Integer EMPTY_INTEGER = Integer.MIN_VALUE;
	final public static Long EMPTY_LONG = Long.MIN_VALUE; 
	final public static DBConnectionInfo EMPTY_DBCONNECTION = new DBConnectionInfo(
			EMPTY_STRING, EMPTY_STRING, EMPTY_STRING, EMPTY_STRING);
	final public static List EMPTY_LIST = Collections
			.unmodifiableList(Collections.emptyList());
	public final static DBConnectionInfo EMPTY_DBDONNECTIONINFO = new DBConnectionInfo(
	...
	public static byte[] compress(final String text, final String encoding)
			throws Exception {
	...
	public static String decompress(byte[] bytes, final String encoding)
			throws Exception {
	...
	public static void main(String... args) throws Exception {
		String input = "There are several methodsnanfn.l";// available in the
																											// Reflection API that can
																											// be used to retrieve
																											// annotations. The
																											...
																											// are unchanged in that
																											// they only return a
																											// single annotation if
																											// one annotation of the
																											// requested type is
																											// present. ";
